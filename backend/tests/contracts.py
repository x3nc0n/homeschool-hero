...
CURRICULUM = {
    ...
    'sources': f'{API_PREFIX}/curriculum/sources',
    'source_search': f'{API_PREFIX}/curriculum/sources/{{source_id}}/search',
    'source_import': f'{API_PREFIX}/curriculum/sources/{{source_id}}/import/{{item_id}}',
    'ai_import': f'{API_PREFIX}/curriculum/ai-import',
    'ai_import_confirm': f'{API_PREFIX}/curriculum/ai-import/confirm',
