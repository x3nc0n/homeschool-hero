...
class Settings(BaseSettings):
    ...
    oer_commons_api_base_url: str = Field('https://www.oercommons.org/api', alias='OER_COMMONS_API_BASE_URL')
    oer_commons_api_token: str | None = Field(default=None, alias='OER_COMMONS_API_TOKEN')
