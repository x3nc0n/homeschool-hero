...
class SchoolYear(TimestampMixin, Base):
    ...
    compliance_reports = relationship('ComplianceReport', back_populates='school_year', cascade='all, delete-orphan')
    report_cards = relationship('ReportCard', back_populates='school_year', cascade='all, delete-orphan')
    transcript_entries = relationship('TranscriptEntry', back_populates='school_year', cascade='all, delete-orphan')
