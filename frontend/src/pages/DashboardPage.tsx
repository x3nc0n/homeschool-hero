    ...
    <PullToRefresh onRefresh={reload}>
      <div className="space-y-4">
        <Card>
          <CardHeader>
            <div>
              ...
              <CardDescription>
                {isStudentView
                  ? 'Today’s schedule, assignments, and recent grades in one place.'
                  : 'A single view of schedule, assignments, grades, attendance, pacing, compliance, and system health.'}
              </CardDescription>
            </div>
        ...
        <div className={`grid gap-4 ${isStudentView ? 'xl:grid-cols-1' : 'xl:grid-cols-[minmax(0,2fr)_minmax(320px,1fr)]'}`}>
          <div className="space-y-4">
            <WidgetCard title="Today’s schedule" description="Scheduled blocks for today." sectionKey="schedule" collapsed={collapsed} onToggle={toggleSection}>
            ...
            <WidgetCard title="Upcoming assignments" description="Due in the next 7 days." sectionKey="assignments" collapsed={collapsed} onToggle={toggleSection}>
            ...
            <WidgetCard title="Recent grades" description="Latest graded submissions." sectionKey="grades" collapsed={collapsed} onToggle={toggleSection}>
          ...
          {!isStudentView ? (
            <div className="space-y-4">
              <WidgetCard title="Attendance snapshot" description="Today’s attendance status for each student." sectionKey="attendance" collapsed={collapsed} onToggle={toggleSection}>
              ...
              <WidgetCard title="Pacing alerts" description="Students currently behind pace." sectionKey="pacing" collapsed={collapsed} onToggle={toggleSection}>
                  ...
                  <div className="space-y-3">
                    {dashboard.pacing_alerts.map((item) => (
                      <div key={item.pacing_target_id} className="rounded-lg border p-3">
                        ...
                        <p className="text-sm text-muted-foreground">{item.package_name} · {item.remaining_lessons} lessons remaining</p>
              ...
              <WidgetCard title="Compliance warnings" description="Warning and non-compliant items that need attention." sectionKey="compliance" collapsed={collapsed} onToggle={toggleSection}>
              ...
              <WidgetCard title="System status" description="Operator summary from the health checks." sectionKey="system" collapsed={collapsed} onToggle={toggleSection}>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="rounded-lg border p-3">
                        ...
                        <p className="text-lg font-semibold">{dashboard.system_status.degraded_services + dashboard.system_status.unhealthy_services}</p>
                      </div>
                    </div>
